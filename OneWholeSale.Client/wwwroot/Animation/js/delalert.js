$("body").on("click","#userChangeStatus",function(e){
    e.preventDefault();
    ...
    $.ajax(
    {
        url: "users/update/"+id, //url.href, or you can use url: "company/"+id,
            type: 'PUT',
            data: {
                _token: token,
                id: id
...
$("body").on("click","#deleteUser",function(e){
    ...
    $.ajax(
    {
          url: "users/"+id, //url.href, or you can use url: "company/"+id,
          type: 'DELETE',
          data: {
            _token: token,
            id: id
